...
**Contracts**: Service [x]
```typescript
// mastra-multi-model-chat に整合: provider + provider 別必須接続設定 + 非空 allowedModels で判定。
