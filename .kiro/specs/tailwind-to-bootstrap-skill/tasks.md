...
- [ ] 1. SKILL.md のスキャフォールディングとフロントマター作成
- [ ] 1.1 スキルディレクトリの作成と YAML フロントマター付きの SKILL.md ファイルを初期化する
...
- [ ] 2. クラスマッピングテーブルセクションの作成
- [ ] 2.1 (P) レイアウト・表示系とフレックスボックス配置のマッピングテーブルを作成する
...
- [ ] 2.4 (P) サイズ・色・ボーダー・レスポンシブのマッピングテーブルを作成する
...
- [ ] 3. 変換不可能パターンセクションの作成
- [ ] 3.1 Bootstrap に等価がないパターンの一覧と代替実装ガイダンスを作成する
...
- [ ] 4. shadcn/ui コンポーネント変換ガイドセクションの作成
- [ ] 4.1 12 個のコンポーネントの変換方針テーブルと CVA/cn() 代替パターンを作成する
...
- [ ] 4.2 Radix UI 維持アプローチとダークモード移行の指針を作成する
...
- [ ] 5. 変換ワークフローセクションの作成
- [ ] 5.1 ステップバイステップの変換手順と検索パターン、依存クリーンアップ手順を作成する
...
- [ ] 6. コンテンツ検証と統合確認
- [ ] 6.1 マッピングの正確性を検証し、SKILL.md が Claude Code で正常に認識されることを確認する
