...
const ACTION_AUDIT_LOG_EXPORT_FAILED = 'AUDIT_LOG_EXPORT_FAILED';
const ACTION_AUDIT_LOG_EXPORT_JOB_EXPIRED = 'AUDIT_LOG_EXPORT_JOB_EXPIRED';
...
export const SupportedAction = {
  ...
  ACTION_AUDIT_LOG_EXPORT_COMPLETED,
  ACTION_AUDIT_LOG_EXPORT_FAILED,
  ACTION_AUDIT_LOG_EXPORT_JOB_EXPIRED,
} as const;
