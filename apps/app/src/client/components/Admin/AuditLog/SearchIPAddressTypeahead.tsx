...
const SearchIPAddressTypeaheadSubstance: ForwardRefRenderFunction<IClearable, Props> = ((props: Props, ref) => {
...
export const SearchIPAddressTypeahead = forwardRef(SearchIPAddressTypeaheadSubstance);
