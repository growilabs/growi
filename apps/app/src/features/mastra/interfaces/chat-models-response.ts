 ...
 *
 * `models` is the allow-list of selectable model ids (the deployment name for the
 ...
 * persisted choice (`UserUISettings.aiChatSelectedModel`) when it is still in the
