 ...
 */
async function collectNamespaceStats() {
 ...
 */
async function computeDirectorySizeBytes(dirPath) {
  let totalBytes = 0;
...
// Controller
// ---------------------------------------------------------------------------
let StorageStatsController = class StorageStatsController {
  /**
...
__decorate(
  ...
  StorageStatsController.prototype,
  'getStorageStats',
  null,
);
StorageStatsController = __decorate(
  [Controller('/internal')],
  StorageStatsController,
);

export { StorageStatsController };
//# sourceMappingURL=storage-stats-controller.js.map
